  ...
  <div class="container">
    ...
    <div class="container-box" v-if="
      ...
      <van-cell-group title="个人信息" class="group-container">
        ...
        <van-cell :value="applicantIdTypeStr" title="证件类型" readonly="true" />
        <van-cell title="证件号码" v-model="addForm.applicantIdNo" :readonly="true"></van-cell>
        <van-cell title="姓名" v-model="addForm.applicantFullName" :readonly="true"></van-cell>
        <van-cell title="年龄" v-model="addForm.applicantAge" :readonly="true"></van-cell>
        <van-cell title="性別" :value="applicantSexStr" readonly="true" />

        <van-cell title="民族" v-model="addForm.applicantNation" :readonly="true"></van-cell>
        <van-cell title="联系地址" v-model="addForm.applicantAddress" :readonly="true"></van-cell>
        <van-cell title="手机号码" v-model="addForm.applicantPhone" :readonly="true"></van-cell>
        <van-cell title="已仲裁或起诉">
          <van-switch v-model="applicantSuedChecked" size="24px" :disabled="true" />
        </van-cell>
        <van-cell :value="caseTypeStr" title="案件类型" readonly="true" />
        <van-field label="案件简介" v-model="addForm.caseDescription" class="textarea-min150" type="textarea" placeholder="案件简介" />
        <div class="">
          <div class="space">
            ...
            <div class="upload-item">
              <van-uploader v-model="applicantIdCardFileList" multiple :disabled="true" max-count="2" :deletable="false" />
            </div>
          </div>
          ...
          <div class="space">
            ...
            <div class="upload-item">
              <van-uploader v-model="applicantEcoProofDoc" max-count="10" :disabled="true" :deletable="false" />
            </div>
          </div>
          <div class="space">
            <div class="upload-item2 van-cell-text">
            ...
            <div class="upload-item">
              <van-uploader v-model="applicantOtherProofDoc" max-count="10" :disabled="true" :deletable="false" />
            </div>
          </div>
        </div>
    ...
    <div class="container-box" v-else>
      <van-cell-group title="个人信息" class="group-container">
        ...
        <mc-input required label="证件号码" v-model="addForm.applicantIdNo"></mc-input>
        <mc-input required label="姓名" v-model="addForm.applicantFullName"></mc-input>
        <mc-input required label="年龄" v-model="addForm.applicantAge"></mc-input>
        ...
        <mc-input required label="民族" v-model="addForm.applicantNation"></mc-input>
        <mc-input required label="联系地址" v-model="addForm.applicantAddress"></mc-input>
        <mc-input required label="手机号码" v-model="addForm.applicantPhone"></mc-input>
