  ...
  <div class="container">
    ...
    <div class="container-box">
      <van-cell-group title="个人信息" class="group-container">
        ...
        />
        <mc-input label="证件号码" v-model="addForm.applicantIdNo"></mc-input>
        <mc-input label="姓名" v-model="addForm.applicantFullName"></mc-input>
        <mc-input label="年龄" v-model="addForm.applicantAge"></mc-input>
        <van-cell
          required
          is-link
          title="性別"
        ...
        <van-action-sheet
          ...
          @select="sexOnChange"
        />
        <mc-input label="民族" v-model="addForm.applicantNation"></mc-input>
        <mc-input
          label="联系地址"
          v-model="addForm.applicantAddress"
        ></mc-input>
        <mc-input label="手机号码" v-model="addForm.applicantPhone"></mc-input>
        <mc-cell label="已仲裁或起诉">
          <van-switch
...
<script>
import { submitFirstApplication, checklawer } from "@/api/legalaid/legalaid";
